...
//   ARRAY ( an ITERABLE)
const arr = [2, "Bright" , "Nigeria", [9, "ten" , [78]]]; 
const shoppingListMen =["boxers", "singlets", "data", "ties", "pants", "shoes", "mommy's shoe" ];
const shoppingListLadies = ["bag", "ear rings", "shoes", "perfume", "make-up box"];
...
const contact_details ={
    firstName: "Bright",
    lastName: "Isioma",
    email: "brisio@gmail.com",
    phoneNo: "+229-43674532",
    address: "c/482 Jerico, Cotonou",
    country: "Benin",
}


console.log(contact_details.email); // console.log(contact_details["email"])
console.log(contact_details["phoneNo"]) // console.log(contact_details.phoneNo);
